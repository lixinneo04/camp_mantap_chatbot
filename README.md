...
[Incoming POST Request to /webhook]
    ...
    [Start 500ms Delay Timer]
      ...
      [Get Conversation History]                     [500ms Expired?]
                │                                       │
      [Image/Pricelist/Tent Request?] ── Yes ──► [handleImageRequest] ──► [Send HTTP 200] (End)
                │ No                                    │
